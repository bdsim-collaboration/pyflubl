...
def IPAC_2026_magnetic() :
    ...
    m.AddDrift(name="t1", length=0.01, beampipeMaterial="SS")
    ...
    m.SaveJSON(this_dir + "/IPAC_2026_magnetic_coordinate.json")
    m.Write(this_dir + "/IPAC_2026_magnetic")
