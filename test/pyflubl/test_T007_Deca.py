...
def make_deca(tilt = 0, offsetX = 0, offsetY = 0, fileName = "T007_Deca"):
    ...
    m.AddDecapole(name="dcp1", length=0.25, k4=-2.5, tilt=tilt, offsetX=offsetX, offsetY=offsetY)
